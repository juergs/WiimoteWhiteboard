/*
    * Harmek/NativeMethods.cs
    https://gist.github.com/Harmek/1263705
...
namespace WiimoteWhiteboard
{
	public partial class Form1 : Form
	{
            ...
            if (ws.IRState.Found1)
            {
                ...
                if (!lastWiiState.IRState.Found1)//mouse down
                {
                    ...
                    if (cursorControl)
                    {
                        ...
                        SendMouseInput((int)warpedX, (int)warpedY, screenWidth, screenHeight, true);
                ...
                else
                {
                    if (cursorControl)//dragging
                    {
                        ...
                        SendMouseInput(x_val, y_val, screenWidth, screenHeight, false);
                    }
                }
            }
            else
        ...
        //-------------------------------------------------------------------------------------------
        public void Keyboard_input(ushort key)
        {
